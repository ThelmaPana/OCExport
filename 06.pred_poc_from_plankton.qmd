...
output_filename <- "data/06.all_preds_poc_from_plankton.Rdata"
```
...
Four plankton variables dominate to explain POC values:
...
-   predict POC values using only these variables

-   reduce dimensionality of plankton data using a PCA
