...
xgb_pdp_sil <- model_profile(explainer = xgb_explain, variables = c("silicate_mean"))
ggplot_pdp(xgb_pdp_sil, silicate_mean) +
  labs(x = "Silicate_mean", y = "Logged predicted POC")

xgb_pdp_oxy <- model_profile(explainer = xgb_explain, variables = c("oxygen_mean"))
ggplot_pdp(xgb_pdp_oxy, oxygen_mean) +
  labs(x = "Oxygen_mean", y = "Logged predicted POC")
```
