...
output_filename <- "data/06.all_preds_poc_from_env.Rdata"
```
...
xgb_pdp_3 <- model_profile(explainer = xgb_explain, variables = c("phosphate"))
ggplot_pdp(xgb_pdp_3, phosphate) +
  labs(x = "Phosphate", y = "Logged predicted POC")
```

## Conclusion

POC can be predicted from a few env variables.
