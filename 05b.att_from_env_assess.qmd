---
title: "Prediction assessment of POC remaining values from env"
...
#|cache: false
source("utils.R")
load("data/05.att_from_env_fit.Rdata")
```
...
::: callout-important
Here we predict the log of remaining fraction of DOC. In terms of interpretation, it means that:

-   high temperature = low remaining DOC = high attenuation

-   low oxygen = low remaining DOC = high attenuation
:::
