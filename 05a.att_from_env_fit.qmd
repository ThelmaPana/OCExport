---
title: "Predict POC remaining values from env"
subtitle: "Train a XGBoost model to predict POC remaining values from environmental data used in Wang et al., 2023."
...
output_filename <- "data/05.att_from_env_fit.Rdata"
```
