...
subtitle: "Train a XGBoost model to predict POC remaining values from selected plankton diversity data."
...
output_filename <- "data/07.att_from_plankton_select_fit.Rdata"
```
