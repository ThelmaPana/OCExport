...
```{r pdp}
xgb_pdp_pielou <- model_profile(explainer = xgb_explain, variables = c("ta_eve"))
ggplot_pdp(xgb_pdp_pielou, ta_eve) +
...
xgb_pdp_shannon <- model_profile(explainer = xgb_explain, variables = c("ta_div"))
ggplot_pdp(xgb_pdp_shannon, ta_div) +
