...
### Links between response variables
...
### Compute mean between taxonomic richness indices

```{r new_ric}
df <- df %>% 
  mutate(ta_ric_mean = (ta_ric_3 + ta_mast) / 2)
```
