...
subtitle: "Train a XGBoost model to predict POC remaining residuals values from plankton PCAd diversity data."
...
output_filename <- "data/12.att_resid_from_plankton_pca_fit.Rdata"
```
