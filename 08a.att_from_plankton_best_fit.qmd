...
subtitle: "Train a XGBoost model to predict POC remaining values from best plankton diversity data."
...
output_filename <- "data/08.att_from_plankton_best_fit.Rdata"
```
...
exp_vars <- df %>% select(abund, mo_size_mean, mo_grey_mean, ta_eve_1) %>% colnames()
# Metadata
meta_vars <- c("lon", "lat")
```
