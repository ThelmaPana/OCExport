...
[(No plankton trophic database to my knowledge.)]{style="color:gray;"}
...
Need to log-transform poc values.
...
plankton_res %>% 
  select(lon:datetime, mo_ric:pred_ta_div) %>% 
  pivot_longer(mo_ric:pred_ta_div) %>% 
  mutate(
